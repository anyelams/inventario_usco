...
module.exports = ({ config }) => ({
  ...
  expo: {
    ...
    extra: {
      ...
      // Inventario
      API_URL_INVENTARIOS_ASIGNADOS: process.env.API_URL_INVENTARIOS_ASIGNADOS,
      API_URL_SUBSECCION_ITEMS: process.env.API_URL_SUBSECCION_ITEMS,
      API_URL_INVENTARIO_PROGRESO: process.env.API_URL_INVENTARIO_PROGRESO,
